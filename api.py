...
from app.models import SimplesNacionalAnexo01
...
def is_CalculoImpostoSimplesNacionalAnexo01():
    ...
    anexo = str(request.form.get("Anexo"))
    ...
    valor_simples_nacional = SimplesNacionalAnexo01.calcula_simples_nacional(receita_bruta)
